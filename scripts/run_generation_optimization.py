#!/usr/bin/env python3
"""
Max-Generation Optimization
=============================

Runs the max-generation enumeration model and saves results to disk.

Usage:
    python scripts/run_generation_optimization.py
"""
...
def main():
    print("=" * 70)
    print("TIDAL TURBINE MAX-GENERATION OPTIMIZATION")
    print("=" * 70)
    ...
    # Run optimization
    print(f"\n[3/4] Running max-generation enumeration...")
    ...
    save_optimization_results(
        ...
        region=REGION,
        model="max_generation",
    )

    print("\n" + "=" * 70)
    print("Max-generation optimization complete.")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    plot_site_map(
        ...
        save_path=str(save_dir / "max_generation_site_map.png"),
    )
